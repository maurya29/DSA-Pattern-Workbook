const CURRENT_PATTERN = {
  ...
  "problems": [
    ...
    },
    {
      ...
      "recursiveCode": "class Solution {\n  public int[] searchRange(int[] nums, int target) {\n    int first = findFirst(nums, target, 0, nums.length - 1, -1);\n    int last = findLast(nums, target, 0, nums.length - 1, -1);\n    return new int[] {first, last};\n  }\n\n  private int findFirst(int[] nums, int target, int left, int right, int answer) {\n    if (left > right) return answer;\n\n    int mid = left + (right - left) / 2;\n    if (nums[mid] >= target) {\n      int nextAnswer = nums[mid] == target ? mid : answer;\n      return findFirst(nums, target, left, mid - 1, nextAnswer);\n    }\n\n    return findFirst(nums, target, mid + 1, right, answer);\n  }\n\n  private int findLast(int[] nums, int target, int left, int right, int answer) {\n    if (left > right) return answer;\n\n    int mid = left + (right - left) / 2;\n    if (nums[mid] <= target) {\n      int nextAnswer = nums[mid] == target ? mid : answer;\n      return findLast(nums, target, mid + 1, right, nextAnswer);\n    }\n\n    return findLast(nums, target, left, mid - 1, answer);\n  }\n}",
      "optimizedCode": "class Solution {\n  public int[] searchRange(int[] nums, int target) {\n    int first = findFirst(nums, target);\n    int last = findLast(nums, target);\n    return new int[] {first, last};\n  }\n\n  private int findFirst(int[] nums, int target) {\n    int left = 0;\n    int right = nums.length - 1;\n    int answer = -1;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n\n      if (nums[mid] >= target) {\n        if (nums[mid] == target) answer = mid;\n        right = mid - 1;\n      } else {\n        left = mid + 1;\n      }\n    }\n\n    return answer;\n  }\n\n  private int findLast(int[] nums, int target) {\n    int left = 0;\n    int right = nums.length - 1;\n    int answer = -1;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n\n      if (nums[mid] <= target) {\n        if (nums[mid] == target) answer = mid;\n        left = mid + 1;\n      } else {\n        right = mid - 1;\n      }\n    }\n\n    return answer;\n  }\n}",
      "code": "class Solution {\n  public int[] searchRange(int[] nums, int target) {\n    int first = findFirst(nums, target);\n    int last = findLast(nums, target);\n    return new int[] {first, last};\n  }\n\n  private int findFirst(int[] nums, int target) {\n    int left = 0;\n    int right = nums.length - 1;\n    int answer = -1;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n\n      if (nums[mid] >= target) {\n        if (nums[mid] == target) answer = mid;\n        right = mid - 1;\n      } else {\n        left = mid + 1;\n      }\n    }\n\n    return answer;\n  }\n\n  private int findLast(int[] nums, int target) {\n    int left = 0;\n    int right = nums.length - 1;\n    int answer = -1;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n\n      if (nums[mid] <= target) {\n        if (nums[mid] == target) answer = mid;\n        left = mid + 1;\n      } else {\n        right = mid - 1;\n      }\n    }\n\n    return answer;\n  }\n}"
    },
    {
    ...
    },
    {
      ...
      "bruteForceCode": "class GuessGame {\n  private final int pick;\n\n  GuessGame(int pick) {\n    this.pick = pick;\n  }\n\n  int guess(int num) {\n    if (num == pick) return 0;\n    return num > pick ? -1 : 1;\n  }\n}\n\nclass Solution extends GuessGame {\n  Solution(int pick) {\n    super(pick);\n  }\n\n  public int guessNumber(int n) {\n    for (int number = 1; number <= n; number++) {\n      if (guess(number) == 0) return number;\n    }\n\n    return -1;\n  }\n}",
      "iterativeCode": "class GuessGame {\n  private final int pick;\n\n  GuessGame(int pick) {\n    this.pick = pick;\n  }\n\n  int guess(int num) {\n    if (num == pick) return 0;\n    return num > pick ? -1 : 1;\n  }\n}\n\nclass Solution extends GuessGame {\n  Solution(int pick) {\n    super(pick);\n  }\n\n  public int guessNumber(int n) {\n    int left = 1;\n    int right = n;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n      int result = guess(mid);\n\n      if (result == 0) return mid;\n      if (result < 0) right = mid - 1;\n      else left = mid + 1;\n    }\n\n    return -1;\n  }\n}",
      "recursiveCode": "class GuessGame {\n  private final int pick;\n\n  GuessGame(int pick) {\n    this.pick = pick;\n  }\n\n  int guess(int num) {\n    if (num == pick) return 0;\n    return num > pick ? -1 : 1;\n  }\n}\n\nclass Solution extends GuessGame {\n  Solution(int pick) {\n    super(pick);\n  }\n\n  public int guessNumber(int n) {\n    return search(1, n);\n  }\n\n  private int search(int left, int right) {\n    if (left > right) return -1;\n\n    int mid = left + (right - left) / 2;\n    int result = guess(mid);\n\n    if (result == 0) return mid;\n    if (result < 0) return search(left, mid - 1);\n    return search(mid + 1, right);\n  }\n}",
      "optimizedCode": "class GuessGame {\n  private final int pick;\n\n  GuessGame(int pick) {\n    this.pick = pick;\n  }\n\n  int guess(int num) {\n    if (num == pick) return 0;\n    return num > pick ? -1 : 1;\n  }\n}\n\nclass Solution extends GuessGame {\n  Solution(int pick) {\n    super(pick);\n  }\n\n  public int guessNumber(int n) {\n    int left = 1;\n    int right = n;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n      int result = guess(mid);\n\n      if (result == 0) return mid;\n      if (result < 0) right = mid - 1;\n      else left = mid + 1;\n    }\n\n    return -1;\n  }\n}",
      "code": "class GuessGame {\n  private final int pick;\n\n  GuessGame(int pick) {\n    this.pick = pick;\n  }\n\n  int guess(int num) {\n    if (num == pick) return 0;\n    return num > pick ? -1 : 1;\n  }\n}\n\nclass Solution extends GuessGame {\n  Solution(int pick) {\n    super(pick);\n  }\n\n  public int guessNumber(int n) {\n    int left = 1;\n    int right = n;\n\n    while (left <= right) {\n      int mid = left + (right - left) / 2;\n      int result = guess(mid);\n\n      if (result == 0) return mid;\n      if (result < 0) right = mid - 1;\n      else left = mid + 1;\n    }\n\n    return -1;\n  }\n}"
    }
  ],
  "checklist": [
