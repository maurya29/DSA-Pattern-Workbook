const CURRENT_PATTERN = {
  "id": "union-find",
  "name": "Union Find",
  "summary": "Connectivity, cycle detection, dynamic components.",
  "complete": true,
  "subpatterns": [
  ...
  "problems": [
    {
      "group": "core",
      "name": "Union Find Drill 1",
      "difficulty": "Easy",
      "subpattern": "Core recognition triggers",
      "question": "Solve a LeetCode-style union find problem focused on core recognition triggers.",
    ...
    {
      "group": "core",
      "name": "Union Find Drill 2",
      "difficulty": "Easy",
      "subpattern": "Common interview variants",
      "question": "Solve a LeetCode-style union find problem focused on common interview variants.",
    ...
    {
      "group": "core",
      "name": "Union Find Drill 3",
      "difficulty": "Easy",
      "subpattern": "Edge-case families",
      "question": "Solve a LeetCode-style union find problem focused on edge-case families.",
    ...
    {
      "group": "core",
      "name": "Union Find Drill 4",
      "difficulty": "Easy",
      "subpattern": "Optimal-code templates",
      "question": "Solve a LeetCode-style union find problem focused on optimal-code templates.",
